...
> `#AI Agents` `#Benchmark Evaluation` `#Browser+CLI+API/MCP` `#Business Workflows` 
> RealReplicaBench is a benchmark for long-horizon agents in high-fidelity replicas of real online services. It spans browser, CLI, API/MCP, document, spreadsheet, research, logistics, and commerce workflows. With stateful local mock services and deterministic or LLM-assisted verifiers, it measures whether models can actually execute real business tasks and produce auditable state changes.
